...
See xref:openapi-swaggerui.adoc#use-swagger-ui-for-development[the Swagger UI] Guide for more details.
...
|@ExceptionHandler
|
|No equivalent annotation in JAX-RS. Exceptions are handled by implementing `jakarta.ws.rs.ext.ExceptionMapper`
|===
