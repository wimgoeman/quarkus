...
You can define different xref:config.adoc#configuration-profiles[configuration profiles]
...
configure your datasource as in the above examples and it will setup Hibernate ORM to use Agroal.
