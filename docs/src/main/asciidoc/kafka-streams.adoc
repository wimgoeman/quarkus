...
:create-app-artifact-id: kafka-streams-quickstart-producer
:create-app-extensions: kafka
:create-app-post-command: mv kafka-streams-quickstart-producer producer
...
:add-extension-extensions: quarkus-smallrye-reactive-messaging-kafka
...
:add-extension-extensions: kafka-streams
include::includes/devtools/extension-add.adoc[]
